''' Возвращаем прокрутку экрана
строки 15 - 17 - нужные переменные
строки 170 - 187 - в основном цикле проверяем место героя, двигаем героя и фон
остальные спрайты остаются на своих местах...
'''
